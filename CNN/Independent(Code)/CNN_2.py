...
def load_person(path):
    ...
    if(os.path.exists(os.path.join(path, 'train_data.npy'))):
            ...
            data_temp_1 = data_temp_1.reshape(-1, 1, data_temp_1.shape[1] * data_temp_1.shape[2])
    ...
    if(os.path.exists(os.path.join(path, 'test_data.npy'))):
            ...
            data_temp_2 = data_temp_2.reshape(-1, 1, data_temp_2.shape[1] * data_temp_2.shape[2])
...
class CNN_net(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Sequential(
            ...
            nn.ReLU(),
            nn.MaxPool1d(kernel_size=8),   # out (1, 4)
           # nn.Dropout(0.3),
        )
